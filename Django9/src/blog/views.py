...
#DetailView : 특정 모델클래스의 하나의 객체를 테플릿에게 전달할때 사용하는 뷰클래스
...
#FormView : 특정 폼 클래스를 템플릿에게 전다라고 GET/POST을 나눠서 처리할때 사용하는 뷰클래스
...
class PostRegister(LoginRequiredMixin, FormView):  
    ...
    def form_valid(self, form):
        ...
        #뷰클래스의 slef.request == 뷰함수의 request 매개변수
...
def searchP(request):
    ...
    #contains 명령: 해당변수에 문자열안에 우변값이 포함되어있는 확인
